...
public class FrmContatos extends JFrame {
	...
	public FrmContatos() {
		...
		painelContatos.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(painelContatos);
		painelContatos.setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBackground(Color.LIGHT_GRAY);
		panel.setBounds(10, 11, 642, 92);
		painelContatos.add(panel);
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Dados de Contato:", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
		panel_1.setBounds(10, 114, 642, 248);
		painelContatos.add(panel_1);
		...
		comboBoxsexo.setModel(new DefaultComboBoxModel(new String[] {"Nao Especificado", "Feminino", "Masculino"}));
		comboBoxsexo.setFont(new Font("Tahoma", Font.PLAIN, 13));
		comboBoxsexo.setBounds(460, 84, 172, 20);
